// File: /Users/pedrosevero/Desktop/code/future-eats/src/app/signup/page.tsx
...
type SecondArg<T extends Function> =
    T extends (...args: [any, infer T]) => any ?
        unknown extends T ?
            any
        :   T
    :   never;
type MaybeField<T, K extends string> =
    T extends { [k in K]: infer G } ?
        G extends Function ?
            G
        :   never
    :   never;
...
type Negative<T extends Numeric> =
    T extends Zero ? never
    : `${T}` extends `-${string}` ? T
    : never;
type NonNegative<T extends Numeric> =
    T extends Zero ? T
