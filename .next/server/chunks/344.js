    ...
    (exports.modules = {
        4344: (e, t, n) => {
            ...
            function m(e) {
                ...
                if (t.props && Array.isArray(t.props.children)) {
                    let e = (e) => {
                        ...
                        return (
                            null == e ? void 0
                            : null == (n = e.props) ? void 0
                            : null == (t = n.dangerouslySetInnerHTML) ? void 0
                            : t.__html
                        );
                    };
                    t.props.children.forEach((t) => {
                        Array.isArray(t) ?
                            t.forEach((t) => e(t) && n.push(t))
                        :   e(t) && n.push(t);
                    });
                }
            ...
            function E(e, t) {
                ...
                return (0, r.jsxs)(r.Fragment, { children: [a, c] });
            }
            class y extends i.default.Component {
                ...
                makeStylesheetInert(e) {
                    return i.default.Children.map(e, (e) => {
                        ...
                        if (
                            ...
                            (null == e ? void 0
                            : null == (t = e.props) ? void 0
                            : t.href) &&
                            o.OPTIMIZED_FONT_PROVIDERS.some((t) => {
                                var n, r;
                                let { url: i } = t;
                                return (
                                    null == e ? void 0
                                    : null == (r = e.props) ? void 0
                                    : null == (n = r.href) ? void 0
                                    : n.startsWith(i)
                                );
                            })
                        ) {
                ...
                render() {
                    ...
                    let {
                            ...
                            dangerousAsPath: f,
                            headTags: h,
                            unstable_runtimeJS: _,
                            unstable_JsPreload: g,
                    ...
                    S && !a && (b = this.makeStylesheetInert(b));
                    let j = !1,
                        R = !1;
                    x = i.default.Children.map(x || [], (e) => {
                        if (!e) return e;
                            ...
                            !a &&
                                (0, r.jsxs)(r.Fragment, {
                                    children: [
                                        ...
                                        !P && !O && this.getPreloadMainLinks(A),
                                        !E && !P && this.getPolyfillScripts(),
                                        !E && !P && this.getPreNextScripts(),
                                        !E && !P && this.getDynamicChunks(A),
                                        !E && !P && this.getScripts(A),
                                        y && this.getCssLinks(A),
                                        y &&
                                            (0, r.jsx)('noscript', {
                                                'data-n-css':
            ...
            class S extends i.default.Component {
                ...
                static getInlineScriptSource(e) {
                    ...
                    try {
                        ...
                        if (f.has(t.page))
                            return (0, a.htmlEscapeJsonString)(i);
                ...
                render() {
                    ...
                    return (0, r.jsxs)(r.Fragment, {
                        children: [
                            ...
                            a && !c && this.getPolyfillScripts(),
                            a && !c && this.getPreNextScripts(),
                            a && !c && this.getDynamicChunks(p),
                            a && !c && this.getScripts(p),
                        ],
                    });
                }
            }
                    ...
                    (function (e, t, n) {
                        ...
                        let l = [],
                            c =
                                ...
                                :   [n.children],
                            u =
                                null == (o = c.find((e) => e.type === y)) ?
                                    void 0
                                : null == (r = o.props) ? void 0
                                : r.children,
                            p =
                                null == (a = c.find((e) => 'body' === e.type)) ?
                                    void 0
                                : null == (s = a.props) ? void 0
                                : s.children,
                            f = [
                                ...(Array.isArray(u) ? u : [u]),
                                ...(Array.isArray(p) ? p : [p]),
            ...
            function T() {
                let { docComponentsRendered: e } = (0, c.useHtmlContext)();
                return (
                    (e.Main = !0),
                    (0, r.jsx)('next-js-internal-body-render-target', {})
                );
            }
            S.contextType = c.HtmlContext;
        ...
        2954: (e, t, n) => {
            ...
            function o(e) {
                ...
                return (
                    t.startsWith('/index/') && !(0, r.isDynamicRoute)(t) ?
                        t.slice(6)
                    : '/index' !== t ? t
                    : '/'
                );
